/**
 * Technical Indicators - Domain Service
 * 
 * Pure mathematical calculations for technical analysis.
 * All methods are stateless and deterministic.
 * This is part of the Domain layer (no external dependencies).
 */
...
} from '../interfaces/IIndicators';

@injectable()
export class TechnicalIndicators implements IIndicators {
    /**
     ...
     */
    volumeAverage(candles: Candle[], period: number = 20): number[] {
        const volumes = candles.map(c => c.volume);
        return this.sma(volumes, period);
    }

    /**
     * Detect if values1 crossed above values2
     */
    ...
    /**
     * Detect if values1 crossed below values2
     */
    ...
    /**
     * Detect trend structure (higher highs, lower lows, etc.)
     */
